...
// Step6
// log your character variable to the console again. You should see the string "Hello", then the string "World", in the console.
...
// Step11
// Remove both console.log statements, and the character reassignment.
